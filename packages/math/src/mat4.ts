...
export class Mat4 extends Float32Array {
  ...
  multiply(other: Mat4Like): this {
    ...
    this[0] =
      a00 * other[0] + a01 * other[4] + a02 * other[8] + a03 * other[12];
    this[1] =
      a00 * other[1] + a01 * other[5] + a02 * other[9] + a03 * other[13];
    this[2] =
      a00 * other[2] + a01 * other[6] + a02 * other[10] + a03 * other[14];
    this[3] =
      a00 * other[3] + a01 * other[7] + a02 * other[11] + a03 * other[15];

    this[4] =
      a10 * other[0] + a11 * other[4] + a12 * other[8] + a13 * other[12];
    this[5] =
      a10 * other[1] + a11 * other[5] + a12 * other[9] + a13 * other[13];
    this[6] =
      a10 * other[2] + a11 * other[6] + a12 * other[10] + a13 * other[14];
    this[7] =
      a10 * other[3] + a11 * other[7] + a12 * other[11] + a13 * other[15];

    this[8] =
      a20 * other[0] + a21 * other[4] + a22 * other[8] + a23 * other[12];
    this[9] =
      a20 * other[1] + a21 * other[5] + a22 * other[9] + a23 * other[13];
    this[10] =
      a20 * other[2] + a21 * other[6] + a22 * other[10] + a23 * other[14];
    this[11] =
      a20 * other[3] + a21 * other[7] + a22 * other[11] + a23 * other[15];

    this[12] =
      a30 * other[0] + a31 * other[4] + a32 * other[8] + a33 * other[12];
    this[13] =
      a30 * other[1] + a31 * other[5] + a32 * other[9] + a33 * other[13];
    this[14] =
      a30 * other[2] + a31 * other[6] + a32 * other[10] + a33 * other[14];
    this[15] =
      a30 * other[3] + a31 * other[7] + a32 * other[11] + a33 * other[15];
    return this;
  }
